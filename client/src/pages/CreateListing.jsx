            ...
            <form className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col gap-3 flex-1 ">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button type='button' onClick={handleImageUpload} className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-95 ">Upload</button>
                    </div>
